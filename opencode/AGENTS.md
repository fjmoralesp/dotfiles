...
- ALWAYS: After implementing a new feature, use the code-reviewer agent to check for issues
- ALWAYS: When asked for adding unit tests, use the test-writer agent for specialized test creation
